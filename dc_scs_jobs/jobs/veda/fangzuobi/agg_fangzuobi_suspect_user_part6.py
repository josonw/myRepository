...
class agg_fangzuobi_suspect_user_part6(BaseStatModel):
    ...
    def stat(self):
        ...
        hql = """
-- b2:隶属于当天注册拥有≥N个账号的IP，N暂定为500
insert overwrite table veda.suspect_user_b2  partition(dt='%(statdate)s')
select a.fuid, a.fip, case when o.fuid is null then 0 else 1 end is null
...
# 生成统计实例
a = agg_fangzuobi_suspect_user_part6(sys.argv[1:])
a()
