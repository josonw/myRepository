...
class agg_gameparty_detail_prechip_dis(BaseStat):
    def create_tab(self):

        hql = """
        CREATE TABLE IF NOT EXISTS dcnew.gameparty_detail_prechip_dis (
                fdate          date,          --
                fgamefsk           bigint,
                fplatformfsk       bigint,
                fhallfsk           bigint,
    ...
    def stat(self):
        ...
        hql = """
        INSERT overwrite TABLE dcnew.gameparty_detail_prechip_dis
...
# 生成统计实例
a = agg_gameparty_detail_prechip_dis(statDate, eid)
a()
