...
class update_dim_table_in_pg(BasePGCluster):
    ...
    def stat(self):
        ...
        INSERT into  dcbase.game_activity_rule_dim (fgamefsk,fact_id,frule_id,fdis_name)
        select   a.fgamefsk, a.fact_id, a.frule_id, a.frule_id fdis_name
        from analysis.game_activity_rule_fct a
        ...
        INSERT into  dcbase.game_activity_dim (fgamefsk,fact_id,fact_name,fdis_name)
        select   a.fgamefsk, a.fact_id, max(a.fact_name) fact_name, max(a.fact_name) fdis_name
        from analysis.game_activity_fct a
        ...
        sql = """delete from dcnew.event_dim where fdate = '%(ld_begin)s';
                 ...
                 insert into dcbase.event_dim (fdate,fgamefsk,fet_id,fet_name)
                 select '%(ld_begin)s' fdate,
                        fgamefsk,
                        fet_id,
                        fet_id
        ...
        sql = """insert into dcnew.subgame_dim (fsubgamefsk,fsubgamename,fgamefsk,priority)
                 ...
                 insert into dcbase.subgame_dim (fsubgamefsk,fsubgamename,fgamefsk,priority)
                 select fsubgamefsk,
                        fsubgamefsk,
                        fgamefsk,
                        0 priority
