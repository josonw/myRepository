...
class agg_alarm_send(BasePGStat):
    ...
    def send_message(self):
        ...
        datestr=datetime.datetime.strftime(datetime.date.today()-datetime.timedelta(days=1), "%Y-%m-%d")
        if self.hql_dict.get('ld_begin','') != datestr:
            sys.exit(0)
