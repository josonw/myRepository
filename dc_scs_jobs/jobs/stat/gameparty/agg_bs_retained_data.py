...
class agg_bs_retained_data(BaseStat):
    """建立游戏维度表
    """
    def create_tab(self):
        hql = """create table if not exists analysis.user_bs_retained_fct
                (
                fdate date,
                fgamefsk bigint,
                fplatformfsk bigint,
    ...
    def stat(self):
        ...
        hql = """
        DROP TABLE IF EXISTS stage.user_bs_retained_tmp;

        CREATE TABLE stage.user_bs_retained_tmp AS
        ...
        from (
            ...
            from analysis.user_bs_retained_fct
        ...
        hql = """
        insert overwrite table analysis.user_bs_retained_fct partition(dt='3000-01-01')
        select
        fdate,
        fgamefsk,
        fplatformfsk,
...
if len(sys.argv) == 1:
    ...
    statDate = args[0]
#生成统计实例
a = agg_bs_retained_data(statDate)
a()
