...
class agg_act_retained_pun_data(BaseStat):
    """建立游戏维度表
    """
    def create_tab(self):
        hql = """create table if not exists analysis.user_pay_retained_fct
                (
                fdate date,
                fgamefsk bigint,
                fplatformfsk bigint,
    ...
    def stat(self):
        ...
        hql = """
        drop table if exists stage.user_pay_retained_tmp;
        create table stage.user_pay_retained_tmp
        as
        ...
        insert overwrite table analysis.user_pay_retained_fct
        partition( dt )
        ...
        select fdate, fgamefsk,fplatformfsk,fversionfsk,fterminalfsk,
                ...
                fdate dt
            from stage.user_pay_retained_tmp
        ...
        hql = """
        insert overwrite table analysis.user_pay_retained_fct partition(dt='3000-01-01')
        select
        fdate,
        fgamefsk,
        fplatformfsk,
        ...
        f14daycnt,
        f30daycnt
        from analysis.user_pay_retained_fct
...
if len(sys.argv) == 1:
    ...
    statDate = args[0]
#生成统计实例
a = agg_act_retained_pun_data(statDate)
a()
